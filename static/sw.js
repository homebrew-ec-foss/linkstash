const CACHE_NAME = 'linkstash-shell-v2';
const CONTENT_CACHE = 'linkstash-content-v2';
const OFFLINE_URL = '/';
...
self.addEventListener('fetch', (event) => {
    ...
    // Don't intercept other dynamic API endpoints (they should always hit the network)
    ...
    // For other requests, try cache then network, falling back gracefully on failure
    event.respondWith(
